...
function SeatGeometryPanel({ venue }) {
  ...
  const rows = ["front", "mid", "back"].map(seat => {
    ...
    return {
      ...
      vfov: hasDist ? M.verticalFovDeg(mask.effH, dist, M.contentBottomFt(venue.screen.h, mask.effH), M.eyeHeightForVenueSeat(venue, dist)) : null,
    };
  });
...
function SeatSelector({ sideA, sideB, seat, onChange }) {
  ...
  function sideSummary(side, venue) {
    ...
    const vfov = M.verticalFovDeg(mask.effH, dist, M.contentBottomFt(venue.screen.h, mask.effH), M.eyeHeightForVenueSeat(venue, dist));
...
function DiagnosisCard({ venue, onCompareTrue, onCompareAnother, onClear }) {
  ...
  const vfov = isDome
    ...
    : (midDist && mask ? M.verticalFovDeg(mask.effH, midDist, M.contentBottomFt(venue.screen.h, mask.effH), M.eyeHeightForVenueSeat(venue, midDist)) : null);
