...
- `schema/theater.schema.json` is version `1.3.0`.
...
- `mugar_omni_boston.json` dome diameter: 76 ft is a community estimate — replace when Museum of Science confirms.
- `imax_cola.json` contrast_sequential: 10,000:1 is a community estimate — no IMAX/Christie published spec.
- `imax_dual_xenon.json` contrast_sequential: 2,000:1 is a community estimate for legacy xenon systems.
