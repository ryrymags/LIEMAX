...
- 2026-06-18 follow-up: fixed 2D workbench masking so presentation windows are fitted inside the physical screen before content masking, making Dolby scope vs flat visibly different; removed 3D POV chair rows; moved scale humans beside the screen at floor level; brightened the dark theater background; and added a split-screen fullscreen control that preserves synced camera movement across both POV panes.
