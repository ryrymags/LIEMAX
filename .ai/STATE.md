...
Current status: "Step 3 complete after audit remediation. Steps 1, 2, and 3 done. Ready for Step 4."

## Completed

- Step 1: Research & Data Schema.
- Step 2: Math Engine.
- `schema/theater.schema.json` is version `1.3.0` (includes `dolby_cinema_single_laser` and `imax_dome_laser` projector_type support; previously 1.2.0).
...
- Step 3 audit remediation applied: schema-valid standard/ScreenX light sources, computable Mugar dome geometry, Mugar post-2021 dome-laser modeling, corrected RPX geometry, full Step 3 data validation, and resolved ScreenX capability preservation.
...
- `mugar_omni_boston` (post-2021 IMAX Dome laser; low-confidence 76 ft dome diameter estimate)
